...
function renderEnglishInstructions_(spreadsheet) {
  ...
  const rows = [
    ...
    ['Applicable', 'Use the checkbox to include or exclude a task. Checked means applicable; unchecked means inactive.'],
    ['Done', 'TODO checkboxes can be selected and DONE checkboxes can be cleared. PENDING and INACTIVE checkboxes are protected.'],
    ['Statuses', 'Status and Waiting for are protected spreadsheet formulas calculated from the Applicable checkbox, Parent ID, Dependencies, and Done.'],
