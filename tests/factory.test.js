...
assert.match(codeSource, /function protectChecklistSheet_\(sheet\)/);
assert.match(codeSource, /function protectConfigurationSheet_\(sheet\)/);
assert.match(codeSource, /protection\.setWarningOnly\(false\)/);
assert.match(codeSource, /protection\.setUnprotectedRanges\(unprotectedRanges \|\| \[\]\)/);
assert.match(codeSource, /protectChecklistSheet_\(sheet\)[\s\S]*?markRuntimeFastPathCompatible_/);
assert.match(factorySource, /protectPoolSheet_\(spreadsheet\)/);
